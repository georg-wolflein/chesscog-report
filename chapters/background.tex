...
\begin{equation}
    h_\text{out} = \left\lfloor \frac{h_\text{in} + 2p - k + 1}{s} \right\rfloor \qquad \text{and} \qquad
    w_\text{out} = \left\lfloor \frac{w_\text{in} + 2p - k + 1}{s} \right\rfloor
\end{equation}
...
We often set $s=k=2$ in order to halve the spatial dimensions.
