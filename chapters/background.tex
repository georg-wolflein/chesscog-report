...
This is how the network facilitates \emph{learning} the input-output function from \cref{eq:reg_model} that was introduced at the very beginning of this chapter to define supervised learning.
