...
\Cref{tbl:chess_recognition_trainval_results} summarises key performance metrics of the end-to-end chess recognition pipeline evaluated on both the training and validation sets (the test set will be evaluated in \cref{chap:evalution}).
\begin{table}
    \makebox[\textwidth][c]{
        \begin{tabular}{lrr}
            \toprule
