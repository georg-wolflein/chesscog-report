...
\end{figure}
Note that although we do not use the bounding boxes in this project, they are useful for future research if someone should use the dataset to train an object recognition model for inferring chess positions instead of the classification-based approach.
