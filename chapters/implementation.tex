...
For more implementation-specific details, the interested reader may consult the code directly; many important methods are described using docstrings and interactive documentation is available, too.
...
More details follow in \cref{sec:user_man_recap_implementation}.
